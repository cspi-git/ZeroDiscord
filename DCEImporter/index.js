...
async function importMessages(){
    ...
    try{
        var response = await request.post(args[0], {
            ...
            body: JSON.stringify({ username: message.author.name, avatar_url: message.author.avatarUrl, content: message.content })
        })
...
messages = JSON.parse(fs.readFileSync(args[1], "utf8")).messages
